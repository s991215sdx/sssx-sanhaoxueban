  ...
  if (submit.isSuccess && submit.data?.kind === "mental") {
    ...
    return (
      <div className="paper-card p-6 text-center">
        ...
        <p className="mono mt-3 text-[11px] tracking-wider text-olive-mute">心理健康筛查（PHQ-9 + GAD-7）· 结果</p>
  ...
  return (
    <div className="paper-card p-6">
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-lg font-bold text-olive">心理健康筛查（PHQ-9 + GAD-7 专业量表）</h2>
          <p className="mt-0.5 text-[13px] text-olive-soft">三甲医院常用筛查工具 · 16 题约 3 分钟 · 结果仅供筛查参考</p>
        </div>
